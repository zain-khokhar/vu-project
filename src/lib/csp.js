...
export function generateCSPHeader(isDevelopment = false) {
  const directives = [
    ...
    // Scripts - allow same-origin, inline scripts (required for Next.js), and eval (for development)
    ...
    // Images - allow same-origin, data URIs, HTTPS, and blob URLs
    "img-src 'self' data: https: blob:",

    // Connections - allow same-origin and required external services
    "connect-src 'self' https://res.cloudinary.com https://drive.google.com",

    // Frames - allow embedding Google Drive documents
