        ...
        <section className="w-full relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-12 grid-rows-2 gap-6 lg:gap-8">
                    {/* --- Left Big Post --- */}
                    {first && (
                        <article className="col-span-12 lg:col-span-6 row-span-2 relative rounded-3xl overflow-hidden group h-[400px] lg:h-[500px] bg-gradient-to-br from-white/70 via-white/60 to-white/50 border border-white/90 shadow-2xl hover:shadow-3xl transition-all duration-500  hover:border-white/100">
                            <Link href={`/blogs/${first.slug}`} className="block relative w-full h-full">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 text-white">
                                    <div className="inline-block bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 px-4 py-2 rounded-full mb-4 shadow-lg">
                    ...
                    {/* --- Right Top Post --- */}
                    {second && (
                        <article className="col-span-12 lg:col-span-6 row-span-1 p-[4px] rounded-3xl bg-gradient-to-r from-purple-400/40 via-blue-400/40 to-purple-400/40 hover:from-purple-500/50 hover:via-blue-500/50 hover:to-purple-500/50 transition-all duration-500 group">
                            <div className="bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500  overflow-hidden h-full">
                                ...
                                <div className="relative p-2 sm:p-6 flex items-center gap-4 h-full">
                                    ...
                                    <div className="flex flex-col justify-center flex-1">
                                        <div className="inline-block bg-gradient-to-r from-pink-500/60 via-purple-500/60 to-pink-500/60 px-2 sm:px-4 py-1 rounded-full mb-2 w-fit">
                                            <span className="uppercase text-xs font-medium text-white">
                                                {second.tags?.[0] || "INSIGHTS"}
                                            </span>
                                        </div>
                                        <Link href={`/blogs/${second.slug}`}>
                                            <h4 className="font-medium text-md md:text-xl text-gray-900 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:via-purple-600 group-hover:to-pink-600 group-hover:bg-clip-text transition-all duration-300 line-clamp-2">
                                                {second.title}
                                            </h4>
                                        </Link>
