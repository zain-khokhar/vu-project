    ...
    return (
        <section className="w-full relative">
            ...
            <div className="grid grid-cols-12 grid-rows-2 gap-6 lg:gap-8">
                {/* --- Left Big Post --- */}
                {first && (
                    <article className="col-span-12 lg:col-span-6 row-span-2 relative rounded-3xl overflow-hidden group h-[400px] lg:h-[500px] backdrop-blur-2xl bg-gradient-to-br from-white/70 via-white/60 to-white/50 border border-white/90 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 hover:border-white/100">
                ...
                {/* --- Right Top Post --- */}
                {second && (
                    <article className="col-span-12 lg:col-span-6 row-span-1 backdrop-blur-2xl bg-gradient-to-br from-white/70 via-white/60 to-white/50 border border-white/90 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 hover:border-white/100 overflow-hidden group">
